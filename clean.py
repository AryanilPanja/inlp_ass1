...
def clean_text(text):
    ...
    # This collapses multiple spaces, tabs, and newlines into a single space
    # and removes leading/trailing whitespace.
    # .split() without arguments automatically handles any whitespace.
...
print("="*30)
# We use min(100, len(en_train)) just in case the list is shorter than 100
...
# Save the full training sets for use in the next task (Tokenization)
# Note: These functions save the FULL 1,000,000+ lines to the files
